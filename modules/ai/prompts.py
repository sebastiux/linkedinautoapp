...
4. Keep each bullet to 1-2 lines (~15-25 words, ~60-180 chars), ONE accomplishment per bullet.
...
6. Tailor WHICH experiences and bullets you emphasise to THIS specific job: lead with and expand the roles/bullets most relevant to it, and condense (but do NOT delete) the less relevant ones. The selection and emphasis MUST genuinely differ between different kinds of roles - e.g. an AI/LLM role, an embedded/hardware role, a frontend role and an IT-support role should each surface different experiences, projects and skills drawn from the master. Reorder the Executive Summary, bullets and skill categories so the most relevant items appear first, in the job's language; prioritise the job's "required" skills over "nice-to-have".
7. Keep ALL sections and ALL real roles of the master resume. NEVER drop a section - in particular ALWAYS keep the full "Certifications and Languages" section (never omit Languages or Certifications), Education, and every employer/role.
8. Length: up to 2 pages is perfectly fine - do NOT worry about fitting one page. Never remove sections, roles, languages or certifications to save space; favour completeness and relevance over brevity.

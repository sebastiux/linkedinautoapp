...
SCHEMA = [
    ...
    ("Bot Settings", "settings", [
        ...
        F("master_resume_path", "Master LaTeX template path", "str",
          help="Your .tex template the AI tailors per job (uses built-in template if left blank/missing)"),
        F("latex_compiler", "LaTeX compiler", "choice", ["auto", "local", "online"],
          help="auto: local xelatex if installed, else online. online needs no install."),
